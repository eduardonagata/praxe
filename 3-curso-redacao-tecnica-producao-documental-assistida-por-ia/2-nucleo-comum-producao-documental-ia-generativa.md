...
Este núcleo estabelece o método de produção, revisão e formatação de documentos formais com apoio de IA generativa, independente do setor de atuação. O conteúdo é agnóstico ao tipo de documento e ao vocabulário da área — as verticais específicas partem daqui e adicionam contexto, exemplos e exigências próprias.
...
Ao concluir o núcleo comum, o participante é capaz de:
...
### Módulo 1 — Fundamentos práticos de IA generativa

Objetivo: estabelecer um modelo mental correto da ferramenta, suficiente para usá-la bem e para reconhecer quando ela erra.
...
- Panorama das ferramentas disponíveis e critérios de escolha (interface de chat, ferramentas integradas ao ambiente de trabalho, uso via API)

### Módulo 2 — Estruturação de instruções para documentos formais

Objetivo: sair do uso improvisado de chat e passar a instruções replicáveis e consistentes.
...
### Módulo 3 — Revisão iterativa e controle de versões

Objetivo: resolver o problema central de trabalhar com documentos longos gerados por IA — revisar sem reler tudo.
...
- Manter histórico de versões de um documento sem depender de "documento_final_v3_revisado.docx"
- Critérios de revisão: o que sempre deve ser verificado manualmente (dados, números, referências normativas, nomes, datas)

### Módulo 4 — Formatação e identidade institucional

Objetivo: transformar o texto produzido em documento final formatado, sem trabalho manual repetitivo.
...
- Manter múltiplos modelos para diferentes tipos de documento ou diferentes destinatários

### Módulo 5 — Segurança da informação e limites de uso

Objetivo: estabelecer critério próprio sobre o que submeter à ferramenta, antes que o hábito se forme errado.

- O que acontece com o conteúdo enviado a uma ferramenta de IA: diferenças entre contas pessoais, contas corporativas e uso via API
- Categorias de informação e nível de cuidado: dados pessoais, informação sigilosa, conteúdo ainda não publicado, material sob restrição contratual ou legal
...
### Módulo 6 — Responsabilidade, revisão humana e governança do resultado
...
**Como parte da consultoria:** conteúdo presencial ou remoto ao vivo, com exercícios sobre documentos reais do cliente.

**Como treinamento autônomo:** videoaulas gravadas, com materiais de apoio (modelos de instrução, arquivos de referência de formatação, checklists) disponíveis para download.

## 6. Carga horária estimada

A definir após o primeiro ciclo de entregas. Estimativa preliminar: 8 a 12 horas para o núcleo comum, considerando exercícios práticos.

## 7. Pré-requisitos

- Uso básico de computador e de editor de texto
- Nenhum conhecimento prévio de programação ou de IA
- Acesso a uma ferramenta de IA generativa durante o treinamento (fornecida ou orientada como parte da consultoria; de responsabilidade do participante no formato autônomo)